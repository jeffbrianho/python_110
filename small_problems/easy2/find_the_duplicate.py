...
# twice. Write a function that finds and returns the duplicate value.
...
"""
P:
I: unordered list with 1 duplicate
O: returns duplicate value
E: only 1 duplicate no other dups
I: assume nummbers
Q
...
dictionary to count?
A
can use each integer as reference and if count is = 2 return value
or iterate from beginning to end
using index increasing the index count each time if, in return **
